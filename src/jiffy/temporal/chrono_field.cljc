...
(defenum create
  [NANO_OF_SECOND ["NanoOfSecond" unit/NANOS unit/SECONDS (value-range/of 0 999999999)]
   ...
   MILLI_OF_SECOND ["MilliOfSecond" unit/MILLIS unit/SECONDS (value-range/of 0 999)]
   MILLI_OF_DAY ["MilliOfDay" unit/MILLIS unit/DAYS (value-range/of 0 (- (* 86400 1000) 1))]
   SECOND_OF_MINUTE ["SecondOfMinute" unit/SECONDS unit/MINUTES (value-range/of 0 59) "second"]
   SECOND_OF_DAY ["SecondOfDay" unit/SECONDS unit/DAYS (value-range/of 0 (- 86400 1))]
   MINUTE_OF_HOUR ["MinuteOfHour" unit/MINUTES unit/HOURS (value-range/of 0 59) "minute"]
   MINUTE_OF_DAY ["MinuteOfDay" unit/MINUTES unit/DAYS (value-range/of 0 (- (* 24 60) 1))]
   HOUR_OF_AMPM ["HourOfAmPm" unit/HOURS unit/HALF_DAYS (value-range/of 0 11)]
   CLOCK_HOUR_OF_AMPM ["ClockHourOfAmPm" unit/HOURS unit/HALF_DAYS (value-range/of 1 12)]
   HOUR_OF_DAY ["HourOfDay" unit/HOURS unit/DAYS (value-range/of 0 23) "hour"]
   CLOCK_HOUR_OF_DAY ["ClockHourOfDay" unit/HOURS unit/DAYS (value-range/of 1 24)]
   AMPM_OF_DAY ["AmPmOfDay" unit/HALF_DAYS unit/DAYS (value-range/of 0 1) "dayperiod"]
   DAY_OF_WEEK ["DayOfWeek" unit/DAYS unit/WEEKS (value-range/of 1 7) "weekday"]
   ALIGNED_DAY_OF_WEEK_IN_MONTH ["AlignedDayOfWeekInMonth" unit/DAYS unit/WEEKS (value-range/of 1 7)]
   ALIGNED_DAY_OF_WEEK_IN_YEAR ["AlignedDayOfWeekInYear" unit/DAYS unit/WEEKS (value-range/of 1 7)]
   DAY_OF_MONTH ["DayOfMonth" unit/DAYS unit/MONTHS (value-range/of 1 28 31) "day"]
   DAY_OF_YEAR ["DayOfYear" unit/DAYS unit/YEARS (value-range/of 1 365 366)]
   EPOCH_DAY ["EpochDay" unit/DAYS unit/FOREVER (value-range/of -365243219162 365241780471)]
   ALIGNED_WEEK_OF_MONTH ["AlignedWeekOfMonth" unit/WEEKS unit/MONTHS (value-range/of 1 4 5)]
   ALIGNED_WEEK_OF_YEAR ["AlignedWeekOfYear" unit/WEEKS unit/YEARS (value-range/of 1 53)]
   MONTH_OF_YEAR ["MonthOfYear" unit/MONTHS unit/YEARS (value-range/of 1 12) "month"]
   PROLEPTIC_MONTH ["ProlepticMonth" unit/MONTHS unit/FOREVER (value-range/of (* year/MIN_VALUE 12) (+ (* year/MAX_VALUE 12) 11))]
   YEAR_OF_ERA ["YearOfEra" unit/YEARS unit/FOREVER (value-range/of 1 year/MAX_VALUE (+ year/MAX_VALUE 1))]
