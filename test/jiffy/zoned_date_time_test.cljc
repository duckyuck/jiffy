...
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/get-offset)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/with-earlier-offset-at-overlap)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/get-zone)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/with-later-offset-at-overlap)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/with-zone-same-local)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/with-zone-same-instant)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/to-local-date-time)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/to-local-date)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/to-local-time)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.chrono-zoned-date-time/format)

;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal/with)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal/plus)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal/minus)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal/until)

;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal-accessor/is-supported)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal-accessor/range)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal-accessor/get)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal-accessor/get-long)
;; (test-proto-fn! jiffy.zoned-date-time jiffy.protocols.temporal-accessor/query)
